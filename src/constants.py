...
SUPPORTED_MODELS = {f"bert-{SIZE_BASE}-{LANGUAGE_MULTILINGUAL}-{CASING_CASED}",
                    ...
                    f"electra-{SIZE_BASE}-generator",
                    f"electra-{SIZE_LARGE}-generator",
                    f"random-bert"
                    }
...
MODEL_DIMS = {f"bert-{SIZE_BASE}-{LANGUAGE_MULTILINGUAL}-{CASING_CASED}": 768,
              ...
              f"electra-{SIZE_BASE}-generator": 256,
              f"electra-{SIZE_LARGE}-generator": 256,
              f"random-bert": 768
              }
...
MODEL_LAYERS = {f"bert-{SIZE_BASE}-{LANGUAGE_MULTILINGUAL}-{CASING_CASED}": 12,
                ...
                f"electra-{SIZE_BASE}-generator": 12,
                f"electra-{SIZE_LARGE}-generator": 24,
                f"random-bert": 12
                }
